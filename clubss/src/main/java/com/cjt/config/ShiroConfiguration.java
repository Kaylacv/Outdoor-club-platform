...
import com.cjt.filter.URLPathMatchingFilter;
import com.cjt.realm.WJRealm;
...
public class ShiroConfiguration {
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(getWJRealm());//配置记住我
        securityManager.setRememberMeManager(rememberMeManager()); //设置认证策略
